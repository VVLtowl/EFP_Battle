...
struct ImPool
{
    ...
    ImPoolIdx       FreeIdx;    // Start free idx to use
...
struct ImGuiContext
{
    ...
    ImGuiWindow*            NavWindowingTarget;                 // Target window when doing CTRL+Tab (or Pad Menu + FocusPrev/Start), this window is temporarily displayed top-most!
    ...
    ImGuiID                             HookIdNext;             // Start available HookId
...
struct IMGUI_API ImGuiTabBar
{
    ...
    ImGuiID             NextSelectedTabId;      // Start selected tab/window. Will also trigger a scrolling animation
